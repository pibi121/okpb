...
print("REQUIRED KEYS:", list(req.keys()))
print("OPTIONAL KEYS:", list(opt.keys()))
for k, v in opt.items():
    print(" opt:", k, str(v)[:150])
'''
...
def main():
    ...
    with sftp.file("/work/_fd_full.py", "w") as f:
        f.write(REMOTE)
    sftp.close()
    stdin, stdout, stderr = client.exec_command("python3 /work/_fd_full.py", timeout=30)
