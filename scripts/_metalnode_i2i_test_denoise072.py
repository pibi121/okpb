...
PROMPT = {
    ...
    "134": {"class_type": "KSampler", "inputs": {"model": ["201", 0], "positive": ["100", 0], "negative": ["135", 0], "latent_image": ["311", 0], "seed": 55219931, "steps": 8, "cfg": 1.3, "sampler_name": "euler", "scheduler": "simple", "denoise": 0.72}},
    "104": {"class_type": "VAEDecode", "inputs": {"samples": ["134", 0], "vae": ["102", 0]}},
    "9": {"class_type": "SaveImage", "inputs": {"images": ["104", 0], "filename_prefix": "Flux2_I2I_TEST_D072"}},
}
